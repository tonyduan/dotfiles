...
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/texbin:/usr/local/include"

# Clojure path
export CLOJURESCRIPT_HOME="/usr/local/clojurescript"
export LEIN_JAVA_CMD="/usr/local/bin/drip"

# Nathan's Horizontal Rule
...
alias ssht='ssh -L 9999:localhost:8888 -R 52698:localhost:52698'
